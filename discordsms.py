...
BASE_URL_TEMPLATE = "[https://sms-spoofer.itxkaal.workers.dev/?mo={number}&text={message}](https://sms-spoofer.itxkaal.workers.dev/?mo={number}&text={message})"
LOG_FILE = "sent.log"
TIMEOUT = 30
DEFAULT_DELAY = 1.0
...
async def help_command(interaction: discord.Interaction):
    msg = ("**Usage:**\n"
           ...
           "/start — show bot info\n"
           "/help — show this help\n\n"
           "Example: `/send +88017XXXXXXX Hello there!`")
...
async def send_command(interaction: discord.Interaction, number: str, message: str):
    ...
    if elapsed < DEFAULT_DELAY:
        ...
        await interaction.response.send_message(f"You're sending too fast. Please wait {wait:.1f}s.", ephemeral=True)
        return
...
if __name__ == "__main__":
    bot.run(MTQyOTgzNjgwNDk2NTc5Nzk4OQ.GZGGdm.cCkiYZP6vffKt1qGF74YIEsiOfONolI_KRDFew)
